...
export function PlaylistDetailManager({
  ...
  return (
    <div className="space-y-4">
        ...
        <div className="mt-3 flex flex-wrap items-center gap-2">
          <Button
            ...
            onClick={async () => {
              ...
              setMessage(result.error ? `Error: ${result.error}` : "Playlist updated.");
            }}
          >
            Save Changes
          </Button>
      ...
      <section className="rounded-xl border border-zinc-800 bg-zinc-900/70 p-4">
        <h2 className="text-sm font-semibold text-zinc-100">Add Track</h2>
        ...
        <div className="mt-3 flex flex-col gap-2 sm:flex-row">
          ...
          <Button
            ...
            onClick={async () => {
              ...
              setMessage(result.error ? `Error: ${result.error}` : "Track added.");
              setSelectedTrackId("");
            }}
            className="sm:w-auto"
          >
        ...
        actionSlot={(track) => (
          <button
            ...
            onClick={async () => {
              ...
              setMessage(result.error ? `Error: ${result.error}` : "Track removed.");
            }}
